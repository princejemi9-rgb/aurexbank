...
function buildReceiptText(receipt: TransferReceipt) {
  return [
    "AUREX BANK OFFICIAL TRANSFER RECEIPT",
    "Private Digital Banking",
    "",
    ...buildReceiptRows(receipt).map(([label, value]) => `${label}: ${value}`),
    "",
    "This digital receipt confirms the transfer was approved through Aurex Secure.",
  ].join("\n");
}
...
export default function SendPage() {
  ...
  function downloadReceiptPdf(receipt: TransferReceipt) {
    ...
    doc.text(
      "This receipt confirms your transfer was approved through Aurex Secure.",
      62,
      168
    );
    ...
    doc.setFontSize(9);
    doc.setTextColor(151, 163, 175);
    doc.text("Generated by Aurex Bank. Keep this receipt for your records.", 62, 728);
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .header { background: #03110a; color: white; padding: 28px; }
            .brand { display: flex; align-items: center; gap: 14px; }
            .mark { width: 48px; height: 48px; border-radius: 12px; background: #00e676; color: #03110a; display: grid; place-items: center; font-size: 24px; font-weight: 900; }
            .status { margin-top: 26px; color: #00e676; font-size: 24px; font-weight: 900; letter-spacing: .08em; }
          ...
          <main class="receipt">
            <section class="header">
              <div class="brand">
                ...
                <div>
                  <h1 style="margin:0;font-size:26px">Aurex Bank</h1>
            ...
            <p class="footer">
              Generated digitally by Aurex Bank. This receipt confirms the transfer
              was approved through Aurex Secure.
            </p>
          </main>
    ...
    <main className="bank-shell min-h-screen overflow-x-hidden text-white">
      ...
      <div className="app-content lg:ml-[16.25rem]">
        <div className="app-inner">
          ...
          {step === 5 && (
            <section className="mx-auto max-w-6xl overflow-hidden rounded-lg border border-green-300/15 bg-[linear-gradient(145deg,rgba(12,28,20,0.94),rgba(3,5,4,0.98))] p-5 shadow-[0_30px_100px_rgba(0,0,0,0.46)] lg:p-8">
