...
export default function CardsPage() {
  ...
  const controls = [
    ...
    { title: "Manage PIN", description: "Unavailable until an issuer connects secure PIN services.", icon: "card" as const, action: undefined },
    { title: "Report Lost or Stolen", description: "Contact support for issuer-backed lost-card reporting.", icon: "shield" as const, action: undefined },
