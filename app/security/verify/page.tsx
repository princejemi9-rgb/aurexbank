...
export default function SecurityVerifyPage() {
  ...
  useEffect(() => {
    ...
    async function checkStatus() {
      ...
      if (active && response?.ok && !status?.bypassed) setConfigured(status?.configured === true);
    }
    void checkStatus().catch(() => null);
    return () => { active = false; };
  }, []);
